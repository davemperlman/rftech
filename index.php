...
<head>
	...
	<meta name="description" content="Build a strong Online Presence with Refined Solutions, a Maine based web development company. We offer a number of cutting edge website services that you can find out more about right here! ">
	<title>Refined Technologies | Website Services</title>
...
<div class="modal-wrap">
	<div class="modal">
		...
		<form action="">
			...
			<input type="subject" name="subject" id="subject" value="Build my Online Presence!">
...
<section class="block banner">
	<!-- Mission Statement -->
	<div>
		<h1>Build a Strong <strong>Online Presence</strong></h1>
	...
	<!-- 	<span class="modal-activate">Get Started</span> -->
		<img src="img/screen.png" alt="Web Solutions from your Computer.">
	</div>
	<span class="modal-activate">Get Started</span>
</section>
<div class="info-wrap">
<!-- 	<section class="block about">
	...
	<section class="block info">
		<div>
			...
			<p>Conceptualizing an internet presence can be an arduous task. What do I want to say - who do I want to say it to - how do I want to say it - These are all questions that we help you to answer. A site isn't just a site anymore. What your site offers will define you or your company in the eyes of your users.</p>
			<h3>Brand Design</h3>
